...
export default {
    ...
    methods: {
        handleReviewSubmitted(review) {
            ...
            this.$toast?.success('Cảm ơn bạn đã đánh giá sản phẩm!') || alert('Cảm ơn bạn đã đánh giá sản phẩm!');
        },
        ...
        isVariantAvailable(colorId, sizeId) {
            return this.allProductDetails.some((detail) => detail.mauSac?.id === colorId && detail.kichCo?.id === sizeId && detail.soLuong > 0);
        },

        updateCurrentProduct() {
            if (!this.selectedColor || !this.selectedSize) return;

            const variant = this.allProductDetails.find((detail) => detail.mauSac?.id === this.selectedColor && detail.kichCo?.id === this.selectedSize);
        ...
        async updateImages() {
            ...
            try {
                ...
                const colorVariants = this.allProductDetails.filter((detail) => detail.mauSac?.id === this.selectedColor);
        ...
        async fetchProduct() {
            try {
                ...
                const [detailResponse, imagesResponse] = await Promise.all([axios.get(`http://localhost:8080/api/san-pham-chi-tiet/${this.productId}`), axios.get('http://localhost:8080/hinh-anh')]);
                ...
                const relatedDetails = allDetailsResponse.data.filter((d) => d.sanPham?.id === currentDetail.sanPham?.id);
        ...
        // Cart methods với backend integration
        ...
        async addToCart() {
            ...
            try {
                if (isAuthenticated) {
                    ...
                    const response = await axios.post(`${API_BASE_URL}/api/gio-hang/add`, requestData, {
                        headers: {
                    ...
                    const existingItemIndex = guestCart.findIndex((item) => item.productDetailId === this.currentProduct.id);
                ...
                if (error.response) {
                    ...
                    // Log request data để so sánh
                    console.error('📤 Request data that failed:', 'Request data not available in catch block');
                ...
                if (error.response?.status === 401) {
                    ...
                    errorMessage = error.response.data?.message || error.response.data?.error || error.response.data || 'Không thể thêm sản phẩm vào giỏ hàng!';
        ...
        async addSimilarToCart(similarProduct) {
            ...
            try {
                if (isAuthenticated) {
                    ...
                    // Check if item already exists
                    const existingItemIndex = guestCart.findIndex((item) => item.productDetailId === similarProduct.firstDetailId);
                    ...
                    if (existingItemIndex >= 0) {
                        ...
                        const newItem = {
                            ...
                            image: similarProduct.image || '/placeholder-shoe.png',
            ...
            <div class="container" v-if="product && !loading">
                <div class="product-wrapper">
                    ...
                    <div class="product-gallery">
                        ...
                        <div class="main-image-container" @mouseenter="pauseAutoSlide" @mouseleave="resumeAutoSlide">
                            <!-- Image Slider -->
                            <div class="image-slider">
                                <transition name="fade" mode="out-in">
                                    <img :key="selectedImageIndex" :src="selectedImage || '/placeholder-shoe.png'" :alt="`${productName} - Image ${selectedImageIndex + 1}`" class="main-image" @error="handleImageError" />
                                </transition>
                            </div>
                            ...
                            <div class="slide-indicators">
                                <span v-for="(image, index) in productImages" :key="index" class="indicator" :class="{ active: selectedImageIndex === index }" @click="selectImage(index)"></span>
                            </div>
                        ...
                        <div class="thumbnail-gallery">
                            <div class="thumbnail-track">
                                <div v-for="(image, index) in productImages" :key="index" class="thumbnail-item" :class="{ active: selectedImageIndex === index }" @click="selectImage(index)" @mouseenter="hoverThumbnail(index)">
                        ...
                        <div class="price-section">
                            <div class="price-wrapper">
                                ...
                                <div class="price-content">
                                    ...
                                    <span class="original-price" v-if="originalPrice && originalPrice !== currentPrice"> {{ formatPrice(originalPrice) }}₫ </span>
                                    <span class="discount-percentage" v-if="discountPercent > 0"> -{{ discountPercent }}% </span>
                                </div>
                            </div>
                        ...
                        <div class="product-options">
                            ...
                            <div class="option-group" v-if="availableColors.length > 0">
                                ...
                                <div class="color-options">
                                    <div v-for="color in availableColors" :key="color.id" class="color-item" :class="{ selected: selectedColor === color.id }" @click="selectColor(color.id)">
                                        <div class="color-circle" :style="{ backgroundColor: getColorHex(color.name) }"></div>
                        ...
                        <div class="purchase-section">
                            <div class="quantity-section">
                                ...
                                <div class="quantity-control">
                                    ...
                                    <input type="number" v-model.number="quantity" @input="validateQuantity" class="qty-input" min="1" :max="currentStock" />
                            ...
                            <div class="action-buttons">
                                <button class="btn-add-cart" @click="addToCart" :disabled="currentStock === 0 || !selectedColor || !selectedSize">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                ...
                                <button class="btn-buy-now" @click="buyNow" :disabled="currentStock === 0 || !selectedColor || !selectedSize">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="product-tabs">
                    ...
                    <div class="tabs-content">
                        ...
                        <div v-if="activeTab === 'description'" class="tab-panel">
                            ...
                            <div class="product-description">
                                ...
                                <ul class="feature-list">
                                    <li v-if="currentProduct.sanPham?.chatLieu"><strong>Chất liệu:</strong> {{ currentProduct.sanPham.chatLieu.tenChatLieu }}</li>
                                    <li v-if="currentProduct.sanPham?.deGiay"><strong>Đế giày:</strong> {{ currentProduct.sanPham.deGiay.loaiDe }}</li>
                                    <li v-if="selectedColorName"><strong>Màu sắc:</strong> {{ selectedColorName }}</li>
                                    <li v-if="selectedSizeName"><strong>Size:</strong> {{ selectedSizeName }}</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div v-if="activeTab === 'reviews'" class="tab-panel">
                            <ReviewProducts :product-id="currentProduct?.id || productId" @review-submitted="handleReviewSubmitted" />
                        </div>
                    </div>
                </div>
                ...
                <div class="similar-products-section">
                    ...
                    <div class="similar-products-slider">
                        <div class="similar-products-grid">
                            <div v-for="similarProduct in similarProducts" :key="similarProduct.id" @click="goToProduct(similarProduct.firstDetailId)" class="similar-product-card">
                                <div class="product-image-wrapper">
                                    <img :src="similarProduct.imgUrl || '/placeholder-shoe.png'" :alt="similarProduct.label" @error="handleSimilarImageError" />
