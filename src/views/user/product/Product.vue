  ...
  methods: {
    ...
    async fetchProduct() {
      try {
        ...
        const detailResponse = await axios.get(`${API_BASE_URL}/api/san-pham-chi-tiet/${this.productId}`);
        ...
        const allDetailsResponse = await axios.get(`${API_BASE_URL}/api/san-pham-chi-tiet`);
